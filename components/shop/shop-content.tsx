      ...
      <div className="container mx-auto px-4 mt-8 md:mt-12">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-full h-12 pl-10 pr-4 bg-[#111111] border-white/5 text-sm text-white placeholder:text-zinc-400 rounded-xl focus:border-orange-500/50 transition-all shadow-sm"
              ...
              <Select onValueChange={(val) => setSelectedCategories([val])}>
                <SelectTrigger className="h-12 bg-[#111111] border-white/5 text-zinc-300 rounded-xl">
                  <SelectValue placeholder="Select Category" />
                </SelectTrigger>
                <SelectContent position="popper" side="bottom" className="bg-[#111111] border-white/10 max-h-[300px]">
                  {categories.map((c) => (
            ...
            {/* Action Bar */}
            <div className="bg-[#111111] p-4 rounded-xl border border-white/5 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center justify-between w-full md:w-auto gap-4">
                <Sheet open={mobileFiltersOpen} onOpenChange={setMobileFiltersOpen}>
                  <SheetTrigger asChild>
                    <Button variant="outline" className="lg:hidden h-10 px-5 rounded-lg border-white/10 font-black text-[10px] uppercase tracking-widest gap-2 bg-transparent text-zinc-300 hover:bg-white/5 hover:text-white">
                      <SlidersHorizontal className="h-3.5 w-3.5" />
                      Filters
                      {activeFiltersCount > 0 && <span className="ml-1 px-1.5 py-0.5 bg-orange-500 text-white rounded-full text-[8px]">{activeFiltersCount}</span>}
                    </Button>
                  </SheetTrigger>
                  <SheetContent side="left" className="w-[300px] p-0 border-none bg-[#0a0a0a]">
                ...
                <p className="text-xs font-black text-zinc-300 uppercase tracking-widest">
                  Found <span className="text-white">{filteredProducts.length}</span> items
                </p>
              </div>
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                <Select value={sortBy} onValueChange={(v) => setSortBy(v as SortOption)}>
                  ...
                  <SelectContent className="rounded-lg border-white/10 bg-[#111111]">
